...
python launch.py --allow-code --xformers --enable-console-prompts --administrator --no-half-vae --disable-opt-split-attention --api --autolaunch --vae-path %VAE_PATH%  --ckpt %GABCHILLSCHKPT%